export default [
    'mare','sole','maestro','martello','pirata','ginocchio','mortaio','gesto','mulino','puntura',
    'vaccino','iginio','poppa','il','prua','quaquaraqua','maresciallo','miracolo','mulino','da','il',
    'xenofobo','webpack','topa','tostapane','gatto','cavallo','vichingo','bello','bicchiere','vigoroso',
    'ferita','zattera','zio','dio','gustoso','orecchini','testardo','albergo','bicchiere','abaco','degli',
